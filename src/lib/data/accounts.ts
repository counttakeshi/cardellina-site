...
export const accounts: SpeciesAccount[] = [
  {
    ...
    "title": "Horned Guan",
    "subtitle": "Oreophasis derbianus Â· Chiapas, Mexico",
    "hero": {
    ...
    "creditHtml": "Â© <a href=\"https://www.instagram.com/oatl_mx/\" target=\"_blank\" rel=\"noopener\">Sergio Gomez Villaverde</a>",
    "quickRef": [
      {
      ...
      {
        "label": "Elevation",
        "value": "2,300 m â€“ 3,350 m"
      },
      {
        "label": "Best months",
        "value": "Year-round; most vocal February â€“ May"
      },
      {
        "label": "Difficulty",
        "value": "High â€” steep hiking required"
      }
    ],
    "body": [
      {
      ...
      {
        "type": "paragraph",
        "html": "The Horned Guan is a year-round resident, believed to remain within established territories. Breeding season at TacanÃ¡ can begin as early as late December, while at El Triunfo it runs from February to March during periods of low rainfall, with nests reportedly built in the mid-canopy â€” though records remain rare."
      },
      {
        "type": "note",
        "label": "Guide notes â€” Ben",
      ...
      {
        "type": "paragraph",
        "html": "With fewer than 2,000 mature individuals remaining, this species is teetering on the edge, especially here in Chiapas. Both El Triunfo and TacanÃ¡ Volcano are now considered biosphere reserves by Mexico's national parks authority, which should aid its protection to some degree."
      },
      {
        "type": "note",
        "label": "Guide notes â€” Valente",
        "html": "Local guides in the region of TacanÃ¡ Volcano are frequently former hunters. Providing these guides with significant income through birding tourism, which depends on the Horned Guan's survival, is a genuinely helpful strategy."
      }
    ],
    "cta": {
      "html": "The Horned Guan is the flagship target species on our TacanÃ¡ Volcano expeditions, and a key draw on multi-day bespoke itineraries into the highlands of Chiapas.",
  ...
  },
  {
    ...
    "subtitle": "Pharomachrus mocinno Â· Chiapas highlands, Mexico",
    "hero": {
      "placeholder": true,
    ...
    "quickRef": [
      ...
      {
        "label": "Elevation",
        "value": "1,000 m â€“ 3,000 m"
      },
      {
        "label": "Best months",
        "value": "December â€“ March"
      },
      {
        "label": "Difficulty",
        "value": "Moderate â€” reliable with a local guide"
      }
    ],
    "body": [
      {
      ...
      },
      {
        "type": "note",
        "label": "Guide notes â€” Valente",
        "html": "Our favourite places for finding the Quetzal are the Lagunas de Montebello, TacanÃ¡ Volcano, and Tapalapa. They are famously found at El Triunfo Biosphere Reserve, but we find the journey there very difficult on the roads and quite time-consuming, relatively speaking."
      },
      {
        "type": "heading",
        "text": "Seasonality and finding the species"
  ...
  },
  {
    ...
    "subtitle": "Cardellina versicolor Â· Chiapas, Mexico",
    "hero": {
    ...
    "body": [
      ...
      {
        "type": "paragraph",
        "html": "The Pink-headed Warbler occurs in just two countries: the highlands of Chiapas in southern Mexico, known locally as Los Altos de Chiapas, and the high-elevation mountain forests of Guatemala. Its global range covers approximately 52,900 kmÂ²,<sup><a href=\"#src1\" aria-label=\"Source 1\">1</a></sup> making it one of the more range-restricted warblers in the Americas. Within Chiapas, the most reliable sites are the forests surrounding San CristÃ³bal de Las Casas and the upper slopes of TacanÃ¡ Volcano, where the species reaches the western limit of its range."
      },
      {
        "type": "paragraph",
        "html": "A pine-oak-alder specialist, it favours open forest with mature pines overhead and dense low shrub beneath, a habitat under sustained pressure from agricultural expansion and charcoal production. The eruption of VolcÃ¡n Chichonal in 1982 is thought to have compounded historical declines, with ash fallout destroying a significant portion of suitable highland forest in the years that followed."
      },
      {
        "type": "heading",
        "text": "Seasonality and finding the species"
    ...
    "cta": {
      "html": "The Pink-headed Warbler is a target species on our San CristÃ³bal highlands day tour, and a key draw on multi-day bespoke itineraries to TacanÃ¡ Volcano.",
      "href": "/trips/day",
      "label": "See our Chiapas birding tours"
    },
    "sources": [
  ...
  },
  {
    ...
    "subtitle": "Passerina rositae Â· Isthmus of Tehuantepec, Mexico",
    "hero": {
    ...
    "quickRef": [
      ...
      {
        "label": "Best months",
        "value": "Resident year-round; easiest in the dry season, roughly November â€“ May"
      },
      {
        "label": "Difficulty",
    ...
    "body": [
      ...
      {
        "type": "paragraph",
        "html": "This species was formerly known as Rosita's Bunting, a reference still maintained in the scientific name <em>Passerina rositae</em>. The first collector of this species was FranÃ§ois Sumichrast, a Swiss naturalist who moved to Mexico in the 1850s. His love for his adoptive country was cemented upon meeting his beautiful wife (as says his contemporary colleague G. N. Lawrence), RosalÃ­a (\"Rosita\") NivÃ³n. The bird was named in reference to her, and his daughter, also named Rosita.<sup><a href=\"#src1\" aria-label=\"Source 1\">1</a></sup>"
      },
      {
        "type": "note",
        "label": "Guide notes â€” Ben",
        "html": "Little is known of Sumichrast's romantic story here in Mexico, but we do know he arrived to Mexico in the 1850's, and married RosalÃ­a in 1870. We can only hazard guesses at where, when, and how, RosalÃ­a and Sumichrast met, but Sumichrast worked for a long period with his base at Santa Efigenia in Tapanatepec, owned by RosalÃ­a's family. RosalÃ­a's divorce from her former husband in 1861 perhaps gives a clue. The coincidence of Rosita's name and Sumichrast's discovery of this rose-coloured bunting is beautifully apt. It appears it was his colleague, George Newbold Lawrence, who decided on the name after receiving specimens from Sumichrast in New York, 1872. At the time Lawrence noted that the bird was as beautiful, if not more, than the Orange-breasted Bunting and Painted Bunting both found nearby. Rosita herself was a mystery for well over a century, listed in the reference works as nothing more than a first name. She was finally identified in 2016 by JosÃ© Alberto Lobato GarcÃ­a, a Mexican birder and biology student, who traced her through Oaxacan records and eventually contacted a living member of the NivÃ³n family for confirmation. It is a lovely piece of detective work, and worth reading in full.<sup><a href=\"#src2\" aria-label=\"Source 2\">2</a></sup>"
      },
      {
        "type": "heading",
        "text": "Identification"
    ...
    "sources": [
      "Boucard, A. (1884). <em>Notice sur FranÃ§ois Sumichrast.</em> Bulletin de la SociÃ©tÃ© Zoologique de France 9: 305â€“312. <a href=\"https://books.google.com/books?id=IsAEAAAAQAAJ\" target=\"_blank\" rel=\"noopener\">books.google.com</a>",
      "Lobato GarcÃ­a, J. A. (\"ElChivizcoyo\"), Raty, L., Bergenholtz, B. et al. (2016). <em>About the name of Passerina rositae.</em> BirdForum discussion thread, in which Rosita was identified as RosalÃ­a NivÃ³n. <a href=\"https://www.birdforum.net/threads/about-the-name-of-passerina-rositae.335730/\" target=\"_blank\" rel=\"noopener\">birdforum.net</a>",
